...
public class FileUploadService {
    ...
    public static final String UPLOAD_DIR = "C:\\Users\\kaushal More\\Project\\ChattingApp\\chat-app\\public\\profile";

    public String uploadFile(MultipartFile photo) {
        try {
            if (photo == null || photo.isEmpty()) {
                throw new GeneralException("Empty file");
            }
            ...
            if (!isImageContentType(photo.getContentType())) {
                throw new GeneralException("Invalid file type. Only images are allowed.");
            }
